...
const OverviewCharts = () => {
    ...
    const barData = [
        { name: 'Indoor', value: 80 },
        { name: 'Outdoor', value: 60 },
        { name: 'Succulents', value: 40 },
    ];
    ...
    const colors = ['#7E22CE', '#facc15', '#f87171']; // Matching your card colors

    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto px-4 py-6">
            {/* Bar Chart - Plant Types Distribution */}
