...
const PlantCard = ({plant}) => {
    return (
        ...
        >
            ...
            <h3 className="text-xl font-semibold text-[#263238] text-center">{plant.name}</h3>
            <p className="text-gray-600 text-sm mt-1 text-center">{plant.category}</p>
            <div className="mt-2">
                <span
            ...
            <p className="health-status text-gray-600 text-sm mt-2 opacity-75 text-center">
